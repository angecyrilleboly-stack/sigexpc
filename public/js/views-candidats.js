...
async function openBordereaux() {
  ...
  content.innerHTML = `<div class="fade-in">
    ...
    <div class="stats-grid" style="margin-bottom:20px;">
      <div class="stat-card" style="cursor:default;background:rgba(6,64,43,0.06);border:1px solid rgba(6,64,43,0.15);">
            ...
            return `<tr style="transition:background 0.15s;" onmouseover="this.style.background='var(--table-hover)'" onmouseout="this.style.background=''">
              <td>
                <div style="display:flex;align-items:center;gap:10px;">
                  <div style="width:38px;height:38px;border-radius:10px;background:rgba(6,64,43,0.1);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
...
function renderInscTable(list) {
  ...
  if (!list.length) {
    ...
    list.forEach(c => {
      let stDisp = '<span class="badge" style="background:rgba(6,64,43,0.1);color:var(--blue);border:1px solid var(--blue);"><i class="fas fa-hourglass-start"></i> Prêt à soumettre</span>';
